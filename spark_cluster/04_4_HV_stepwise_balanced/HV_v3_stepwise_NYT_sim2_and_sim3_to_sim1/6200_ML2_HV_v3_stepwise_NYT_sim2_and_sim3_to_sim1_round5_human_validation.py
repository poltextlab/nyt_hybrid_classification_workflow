...
#################################################
spark = SparkSession.builder.appName('ML2_HV_v3_stepwise_NYT_sim2_and_sim3_to_sim1_round5_human_validation').config(conf=conf).getOrCreate()
...
df_results = spark.read.parquet("hdfs://192.168.0.182:9000/input/ML2_HV_v3_stepwise_NYT_r5_classified.parquet").repartition(50)
...
df_numbers.to_csv("ML2_HV_v3_stepwise_NYT_human_validation_numbers_r5.csv", index=True)
...
df_original = spark.read.parquet("hdfs://192.168.0.182:9000/input/ML2_HV_v3_stepwise_NYT_r5_train_and_remaining_NOTclassified.parquet").repartition(50)
...
df_original.write.parquet("hdfs://192.168.0.182:9000/input/ML2_HV_v3_stepwise_NYT_round6_start.parquet", mode="overwrite")
...
df_original = spark.read.parquet("hdfs://192.168.0.182:9000/input/ML2_HV_v3_stepwise_NYT_round6_start.parquet").repartition(50)
df_original = df_original.drop('text', 'words', 'features', 'raw_features').toPandas()
df_original.to_csv("ML2_HV_v3_stepwise_NYT_round6_starting_table.csv", index=False)
